        ...
        <div className="max-w-3xl mx-auto animate-fade-in">
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4 text-lg leading-relaxed">
              <p>
                Безнең максатыбыз – татар телен саклау һәм үстерү, аны өйрәнүдә заманча һәм кызыклы уеннар тудыру, 
                балаларга һәм өлкәннәргә телне табигый һәм кызыклы рәвештә үстерүгә ярдәм итү.
              </p>
              <p>
